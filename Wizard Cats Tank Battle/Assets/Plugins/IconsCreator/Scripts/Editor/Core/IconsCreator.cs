...
namespace IconsCreationTool.Editor.Core
{
    public class IconsCreator
    {
        ...
        public void SetData(IconsCreatorData data)
        {
            ...
            _cameraUtility.SetData(_data.Targets.FirstOrDefault(), _data.Size, _data.Padding, _data.CameraDistance, _data.OffsetX, _data.OffsetY);
        ...
        {
            _cameraUtility.SetData(target, _data.Size, _data.Padding, _data.CameraDistance, _data.OffsetX, _data.OffsetY);
