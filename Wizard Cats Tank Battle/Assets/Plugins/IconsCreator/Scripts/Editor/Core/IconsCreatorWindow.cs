...
namespace IconsCreationTool.Editor.Core
{
    public class IconsCreatorWindow : EditorWindow
    {
        ...
        [SerializeField] private float offsetX = 45;
        [SerializeField] private float offsetY = -45;
        ...
        private SerializedProperty _cameraDistance;
        ...
        private void Load()
        {
            ...
            cameraDistance = EditorPrefs.GetFloat(nameof(cameraDistance));
            offsetX = EditorPrefs.GetFloat(nameof(offsetX));
            offsetY = EditorPrefs.GetFloat(nameof(offsetY));
        }
        ...
        private void SetupSerializedProperties()
        {
            ...
            _cameraDistance = _serializedObject.FindProperty(nameof(cameraDistance));
            _offsetX = _serializedObject.FindProperty(nameof(offsetX));
            _offsetY = _serializedObject.FindProperty(nameof(offsetY));
        }
        ...
        private void Save()
        {
            ...
            EditorPrefs.SetFloat(nameof(cameraDistance), cameraDistance);
            EditorPrefs.GetFloat(nameof(offsetX), offsetX);
            EditorPrefs.GetFloat(nameof(offsetY), offsetY);
        }
        ...
        private void DrawCameraOptions()
        {
            using (IconsCreatorWindowElements.VerticalScope)
            {
                IconsCreatorWindowElements.DrawBoldLabel("Camera");
        ...
        private void UpdateIconsCreator()
        {
            ...
            IconsCreatorData data =
                new IconsCreatorData(size, padding, prefix, suffix, backgroundData, targets, renderShadows, cameraDistance, offsetX, offsetY);
